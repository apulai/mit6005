...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(piHexDigits));
        System.out.printf(
